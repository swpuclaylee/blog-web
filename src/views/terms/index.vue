<template>
  <div class="container">
    ...
    <div class="content-container markdown-body animated fadeIn">
      <h1 style="text-align: center;">云初的博客用户协议</h1>
      <h3>导言</h3>
      <p>欢迎使用“云初的博客”以及相关服务！</p>
      <p>为了更好地向您提供服务，请您在使用“云初的博客”及相关服务之前，认真阅读并理解本协议。</p>
      <h3>关于账号</h3>
      <p>(a)“云初的博客”及相关服务为您提供了注册通道，你有权选择合法的字符组合作为自己的账号，并自行设置符合安全要求的密码。用户设置的账号、密码是用户用以登录并使用“云初的博客”及相关服务的凭证。  </p>
